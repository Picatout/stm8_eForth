...
Hexadecimal [24-Bits]
      ...
      0080AE 97 1E                  238         .word       LASTN   ;CONTEXT pointer
      0080B0 00 80                  239         .word       CTOP   ;CP in RAM
      0080B2 97 1E                  240         .word      LASTN   ;LAST
...
Hexadecimal [24-Bits]
      ...
      009638 81               [ 4]  133 	ret
                                    ...
                                    138 ;  UNLOCK ( -- )
                                    139 ;-----------------------------
      009639 96 1C                  140 	.word LINK 
                           0015BB   141 	LINK=.
      00963B 06                     142 	.byte 6
      00963C 55 4E 4C 4F 43 4B      143 	.ascii "UNLOCK"
      009642                        144 unlock:
                                    145 ; put addr[15:0] in Y, for bounds check.
      009642 90 BE 03         [ 2]  146 	ldw y,ptr16   ; Y=addr15:0
                                    147 ; check addr[23:16], if <> 0 then it is extened flash memory
      009645 3D 02            [ 1]  148 	tnz farptr 
      009647 26 16            [ 1]  149 	jrne 4$
      009649 90 A3 97 9C      [ 2]  150     cpw y,#user_space
      00964D 24 10            [ 1]  151     jruge 4$
      00964F 90 A3 40 00      [ 2]  152 	cpw y,#EEPROM_BASE  
      009653 25 0D            [ 1]  153     jrult 9$
      009655 90 A3 48 7F      [ 2]  154 	cpw y,#OPTION_END 
      009659 22 07            [ 1]  155 	jrugt 9$
      00965B CD 96 04         [ 4]  156 	call unlock_eeprom
      00965E 81               [ 4]  157 	ret 
      00965F CD 96 23         [ 4]  158 4$: call unlock_flash
      009662 81               [ 4]  159 9$: ret 
                                    160 
                                    161 ;-------------------------
...
Hexadecimal [24-Bits]
                                    ...
                                    165 ;-------------------------
      009663 96 3B                  166 	.word LINK 
                           0015E5   167 	LINK=.
      009665 04                     168 	.byte 4 
      009666 4C 4F 43 4B            169 	.ascii "LOCK" 
      00966A                        170 lock: 
      00966A 72 13 50 5F      [ 1]  171 	bres FLASH_IAPSR,#FLASH_IAPSR_PUL
      00966E 72 17 50 5F      [ 1]  172 	bres FLASH_IAPSR,#FLASH_IAPSR_DUL
      009672 81               [ 4]  173 	ret 
                                    174 
                                    175 ;-------------------------
                                    ...
                                    177 ; INC-FPTR ( -- )
                                    178 ;-------------------------
      009673 96 65                  179 	.word LINK 
                           0015F5   180 	LINK=. 
      009675 08                     181 	.byte 8 
      009676 49 4E 43 2D 46 50 54   182 	.ascii "INC-FPTR" 
             52
      00967E                        183 inc_fptr:
      00967E 3C 04            [ 1]  184 	inc ptr8 
      009680 26 08            [ 1]  185 	jrne 1$
      009682 90 BE 02         [ 2]  186 	ldw y,farptr 
      009685 90 5C            [ 2]  187 	incw y 
      009687 90 BF 02         [ 2]  188 	ldw farptr,y 
      00968A 81               [ 4]  189 1$: ret 
                                    190 
                                    191 
                                    192 ;----------------------------
                                    ...
                                    198 ;----------------------------
                                    199 
      00968B 96 75                  200 	.word LINK 
                           00160D   201 	LINK=. 
      00968D 07                     202 	.byte 7 
      00968E 57 52 2D 42 59 54 45   203 	.ascii "WR-BYTE" 
                                    204 
      009695                        205 write_byte:
      009695 90 93            [ 1]  206 	ldw y,x 
      009697 90 FE            [ 2]  207 	ldw y,(y)
      009699 1C 00 02         [ 2]  208 	addw x,#CELLL 
      00969C 90 9F            [ 1]  209 	ld a,yl
      00969E 92 BD 00 02      [ 4]  210 	ldf [farptr],a
      0096A2 72 05 50 5F FB   [ 2]  211 	btjf FLASH_IAPSR,#FLASH_IAPSR_EOP,.
      0096A7 20 D5            [ 2]  212 	jra inc_fptr 
                                    213 
                                    214 
                                    215 
                                    216 ;---------------------------------------
...
Hexadecimal [24-Bits]
                                    ...
                                    219 ;---------------------------------------
      0096A9 96 8D                  220     .word LINK 
                           00162B   221 	LINK=.
      0096AB 04                     222     .byte 4 
      0096AC 45 45 43 21            223     .ascii "EEC!"
                                    224 	; local variables 
                           000001   225 	BTW = 1   ; byte to write offset on stack
                           000002   226     OPT = 2 
                           000002   227 	VSIZE = 2
      0096B0                        228 ee_cstore:
      0096B0 52 02            [ 2]  229 	sub sp,#VSIZE
      0096B2 CD 95 A0         [ 4]  230     call fptr_store
      0096B5 E6 01            [ 1]  231 	ld a,(1,x)
      0096B7 43               [ 1]  232 	cpl a 
      0096B8 6B 01            [ 1]  233 	ld (BTW,sp),a ; byte to write 
      0096BA 0F 02            [ 1]  234 	clr (OPT,sp)  ; OPTION flag
      0096BC CD 96 42         [ 4]  235 	call unlock 
                                    236 	; check if option
      0096BF 3D 02            [ 1]  237 	tnz farptr 
      0096C1 26 19            [ 1]  238 	jrne 2$
      0096C3 90 BE 03         [ 2]  239 	ldw y,ptr16 
      0096C6 90 A3 48 00      [ 2]  240 	cpw y,#OPTION_BASE
      0096CA 2B 10            [ 1]  241 	jrmi 2$
      0096CC 90 A3 48 80      [ 2]  242 	cpw y,#OPTION_END+1
      0096D0 2A 0A            [ 1]  243 	jrpl 2$
      0096D2 03 02            [ 1]  244 	cpl (OPT,sp)
                                    245 	; OPTION WRITE require this unlock 
      0096D4 72 1E 50 5B      [ 1]  246     bset FLASH_CR2,#FLASH_CR2_OPT
      0096D8 72 1F 50 5C      [ 1]  247     bres FLASH_NCR2,#FLASH_CR2_OPT 
      0096DC                        248 2$: 
      0096DC CD 96 95         [ 4]  249 	call write_byte 	
      0096DF 0D 02            [ 1]  250 	tnz (OPT,sp)
      0096E1 27 0D            [ 1]  251 	jreq 3$ 
      0096E3 7B 01            [ 1]  252     ld a,(BTW,sp)
      0096E5 90 5F            [ 1]  253     clrw y
      0096E7 90 97            [ 1]  254 	ld yl,a 
      0096E9 1D 00 02         [ 2]  255 	subw x,#CELLL 
      0096EC FF               [ 2]  256 	ldw (x),y 
      0096ED CD 96 95         [ 4]  257 	call write_byte
      0096F0                        258 3$: 
      0096F0 CD 96 6A         [ 4]  259 	call lock 
      0096F3 5B 02            [ 2]  260 	addw sp,#VSIZE 
      0096F5 81               [ 4]  261     ret
                                    262 
                                    263 ;------------------------------
                                    ...
                                    265 ; EE! ( n ud -- )
                                    266 ;------------------------------
      0096F6 96 AB                  267 	.word LINK 
                           001678   268 	LINK=.
      0096F8 03                     269 	.byte 3 
      0096F9 45 45 21               270 	.ascii "EE!"
      0096FC                        271 ee_store:
      0096FC CD 95 A0         [ 4]  272 	call fptr_store 
      0096FF CD 96 42         [ 4]  273 	call unlock 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 77.
Hexadecimal [24-Bits]



      009702 90 93            [ 1]  274 	ldw y,x 
      009704 90 FE            [ 2]  275 	ldw y,(y)
      009706 90 89            [ 2]  276 	pushw y 
      009708 90 5E            [ 1]  277 	swapw y 
      00970A FF               [ 2]  278 	ldw (x),y 
      00970B CD 96 95         [ 4]  279 	call write_byte 
      00970E 90 85            [ 2]  280 	popw y 
      009710 1D 00 02         [ 2]  281 	subw x,#CELLL
      009713 FF               [ 2]  282 	ldw (x),y 
      009714 CD 96 95         [ 4]  283 	call write_byte
      009717 72 13 50 5F      [ 1]  284 	bres FLASH_IAPSR,#FLASH_IAPSR_PUL
      00971B 81               [ 4]  285 	ret 
                                    286 
                                    287 ;----------------------------
                                    ...
                                    290 ; ROW-ERASE ( ud -- )
                                    291 ;----------------------------
      00971C 96 F8                  292 	.word LINK 
                           00169E   293 	LINK=. 
      00971E 09                     294 	.byte 9 
      00971F 52 4F 57 2D 45 52 41   295 	.ascii "ROW-ERASE" 
             53 45
      009728                        296 row_erase:
      009728 CD 95 A0         [ 4]  297 	call fptr_store
                                    298 ;code must be execute from RAM 
                                    299 ;copy routine to PAD 
      00972B 1D 00 02         [ 2]  300 	subw x,#CELLL 
      00972E 90 AE 97 75      [ 2]  301 	ldw y,#row_erase_proc
      009732 FF               [ 2]  302 	ldw (x),y 
      009733 CD 88 38         [ 4]  303 	call PAD 
      009736 90 AE 97 9C      [ 2]  304 	ldw y,#row_erase_proc_end 
      00973A 72 A2 97 75      [ 2]  305 	subw y,#row_erase_proc
      00973E 1D 00 02         [ 2]  306 	subw x,#CELLL 
      009741 FF               [ 2]  307 	ldw (x),y 
      009742 CD 88 74         [ 4]  308 	call CMOVE 
      009745                        309 block_erase:
      009745 90 BE 03         [ 2]  310 	ldw y,farptr+1
      009748 90 A3 97 9C      [ 2]  311 	cpw y,#user_space 
      00974C 2A 13            [ 1]  312 	jrpl erase_flash 
                                    313 ; erase eeprom block
      00974E 90 A3 40 00      [ 2]  314 	cpw y,#EEPROM_BASE 
      009752 24 01            [ 1]  315 	jruge 1$
      009754 81               [ 4]  316 	ret ; bad address 
      009755 90 A3 47 FF      [ 2]  317 1$: cpw y,#EEPROM_END 
      009759 23 01            [ 2]  318 	jrule 2$ 
      00975B 81               [ 4]  319 	ret ; bad address 
      00975C                        320 2$:	
      00975C CD 96 04         [ 4]  321 	call unlock_eeprom 
      00975F 20 03            [ 2]  322 	jra proceed_erase
                                    323 ; erase flash block:
      009761                        324 erase_flash:
      009761 CD 96 23         [ 4]  325 	call unlock_flash 
      009764                        326 proceed_erase:
      009764 CD 88 38         [ 4]  327 	call PAD 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 78.
Hexadecimal [24-Bits]



      009767 90 93            [ 1]  328 	ldw y,x
      009769 90 FE            [ 2]  329 	ldw y,(y)
      00976B 1C 00 02         [ 2]  330 	addw x,#CELLL  
      00976E 90 FD            [ 4]  331 	call (y) 
      009770 72 17 50 5F      [ 1]  332 	bres FLASH_IAPSR,#FLASH_IAPSR_DUL
      009774 81               [ 4]  333 	ret 
                                    334 
                                    335 ; this routine is to be copied to PAD 
      009775                        336 row_erase_proc:
      009775 35 20 50 5B      [ 1]  337 	mov FLASH_CR2,#(1<<FLASH_CR2_ERASE) 
      009779 35 DF 50 5C      [ 1]  338 	mov FLASH_NCR2,#~(1<<FLASH_CR2_ERASE)
      00977D 4F               [ 1]  339 	clr a 
      00977E 90 5F            [ 1]  340 	clrw y 
      009780 91 A7 00 02      [ 1]  341 	ldf ([farptr],y),a
      009784 90 5C            [ 2]  342     incw y
      009786 91 A7 00 02      [ 1]  343 	ldf ([farptr],y),a
      00978A 90 5C            [ 2]  344     incw y
      00978C 91 A7 00 02      [ 1]  345 	ldf ([farptr],y),a
      009790 90 5C            [ 2]  346     incw y
      009792 91 A7 00 02      [ 1]  347 	ldf ([farptr],y),a
      009796 72 05 50 5F FB   [ 2]  348 	btjf FLASH_IAPSR,#FLASH_IAPSR_EOP,.
      00979B 81               [ 4]  349 	ret
      00979C                        350 row_erase_proc_end:
                                    351 
                                    352 
                           000000   353 .if 0
                                    354 ;-----------------------------------
